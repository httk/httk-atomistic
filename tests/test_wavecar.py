...
if numpy is not None:
    from httk.atomistic.integrations.vasp.io.wavecar import WavecarFile, _write_wavecar_payload, read_wavecar
...
def test_import_and_wavecar_import_without_numpy() -> None:
    ...
    script = (
        ...
        "import httk.atomistic.io.cif as cif\n"
        "assert hasattr(cif, 'read_cif')\n"
        "try:\n"
        "    importlib.import_module('httk.atomistic.integrations.vasp.io.wavecar')\n"
        "except ImportError as error:\n"
        "    assert 'httk-atomistic[numpy]' in str(error), error\n"
        "else:\n"
