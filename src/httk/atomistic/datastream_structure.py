...
class DatastreamStructure(StructureBackend):
    ...
    def __new__(cls, obj: Any, **hints: Any) -> Any:
        ...
        if (isinstance(obj, str) and not cls._is_stream_source(obj) or isinstance(obj, httk.core.DatastreamURL)) and optimade:
            return super().__new__(cls)
        return None
    ...
    def _native(self) -> Any:
        ...
        if isinstance(source, httk.core.DatastreamURL):
            ...
            stream = source if isinstance(source, httk.core.TextstreamFileView) else httk.core.TextstreamFileView(source)
