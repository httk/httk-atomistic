...
from . import sites, sites_backend, sites_view_base

# Sites are any sites backend/view, a Sites, or any Nx3 vector-like (nested numbers, FracVector,
# SurdVector, numpy array, ...).
type SitesLike = sites_backend.SitesBackend | sites_view_base.SitesViewBase | sites.Sites | httk.core.VectorLike
