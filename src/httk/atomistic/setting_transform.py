...
systematically wrong crystal, which is why :func:`for_hall_entry` is checked against the
tabulated symmetry operations in the test suite rather than trusted.
