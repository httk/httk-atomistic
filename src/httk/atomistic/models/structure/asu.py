...
class FundamentalDomainStructure(StructureSemanticsMixin, StructureBackend):
    ...
    def _expansion(self) -> tuple[FracVector, tuple[str, ...], tuple[int, ...]]:
        ...
        point cannot silently produce a doubled atom. A site whose orbit contributes no new
        points raises ``ValueError`` because it duplicates an earlier site's orbit.
        """
