...
from httk.atomistic.models.chromastructure.anonymize import canonical_dummy_assignment, dummy_species
...
class FundamentalDomainPatternView(ChromastructureViewBase, FundamentalDomainPattern):
    ...
    :param obj: The chromastructure-like or structure-like source.
    ...
    def _effective_prototype(self) -> FundamentalDomainPattern:
        ...
        if isinstance(backend, FundamentalDomainPattern):
            ...
            source: Any
            anonymous_source = isinstance(backend, Chromastructure)
            if anonymous_source:
