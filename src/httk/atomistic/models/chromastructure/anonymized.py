...
class AnonymizedStructure(ChromastructureBackend):
    ...
    def _backend_adopt(cls, obj: Any, **hints: Any) -> Self | None:
        ...
        if hints and hints.get("kind", "structure") != "structure":
            return None
        if isinstance(obj, ChromastructureBackend):
            return None
    ...
    @cached_property
    def _derived(self) -> Chromastructure:
        ...
        return Chromastructure(view.cell, view.sites, mapped_species, mapped_sites)

    def resolve(self) -> Chromastructure:
