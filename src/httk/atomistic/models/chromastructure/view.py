"""Lazy chromastructure presentation view."""
...
class ChromastructureView(ChromastructureViewBase, Chromastructure):
    r"""Present a chromastructure or ordinary structure lazily as a chromastructure.

    :param obj: The chromastructure-like or structure-like object to present.
    :param \*\*hints: Backend-selection hints.
    """

    _backend: ChromastructureBackend

    def __new__(cls, obj: "ChromastructureLike | StructureLike", **hints: Any) -> Self:
    ...
    def unview(self) -> Chromastructure:
        """Return the presented structure as a standalone value.

        :return: The chromastructure value.
        """
        if type(self._backend) is Chromastructure:
            return self._backend
        return Chromastructure(self.cell, self.sites, self.species, self.species_at_sites)
