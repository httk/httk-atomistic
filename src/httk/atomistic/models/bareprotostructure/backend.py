...
from httk.atomistic.models.bareprotostructure.api import BareProtostructureAPI


class BareProtostructureBackend(Backend["BareProtostructureBackend"], BareProtostructureAPI):
