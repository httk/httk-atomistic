...
class BareProtostructureAPI(ABC):
    ...
    def formula(self) -> ChemicalFormulaView:
        ...
        """
        return ChemicalFormulaView(cast("BareProtostructureBackend", self))
    ...
    def anonymous_formula(self) -> FormulatypeView:
        ...
        """
        return FormulatypeView(cast("BareProtostructureBackend", self))

    @property
    def label(self) -> "BareProtostructureLabel":
        ...
        *canonical* protostructure label comes from a normalizer-canonical protostructure.
        ...
        return BareProtostructureLabel(cast("BareProtostructureBackend", self))
    ...
    @property
    def bare_protostructure(self) -> Self:
