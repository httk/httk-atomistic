...
from httk.atomistic.models.prototype.notation import try_parse_bare_protostructure


class BareProtostructureLabelString(BareProtostructureBackend):
    ...
    prototype labels are declined (they belong to the prototype family). Each name
    ...
    def _backend_adopt(cls, obj: Any, **hints: Any) -> Self | None:
        ...
        """
        if hints and hints.get("kind", "bare_protostructure") != "bare_protostructure":
            return None
        if not isinstance(obj, str):
            return None
        if try_parse_bare_protostructure(obj) is None:
            return None
        return cls(obj, **hints)

    def __init__(self, obj: str, **hints: Any) -> None:
        self._raw = obj
        parsed = try_parse_bare_protostructure(obj)
